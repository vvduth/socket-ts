...
class Client {
  ...
  private alertWinnerLoosers: boolean[] = [false, false, false];
      ...
      gameStates.forEach((gameState) => {
        ...
        if (gameState.gameClock >= 0) {
          if (gameState.gameClock >= gameState.duration) {
            ...
            this.alertWinnerLoosers[gid] = false;
            for (let x = 0; x < 10; x++) {
          ...
          if (
            ...
            !this.alertWinnerLoosers[gid] &&
            gameState.winnerCalclated
          ) {
            ...
            this.alertWinnerLoosers[gid] = true;
          }
        }
      });
    });
